...
with h5py.File("template_bank_2_300_30Hz_fd_half_precision.h5", "w") as f:
    f.create_dataset("strain", data=hp_fd_waves, dtype=np.complex64)  # Save complex 
    f.create_dataset("frequencies", data=freqs, dtype=np.float32)  # Save frequencies
